...
> As "clients are allowed to insert any value", i.e. users can enter the date they want when posting, some aberrant dates can be found! Check on the [False posting dates part](#false-dates) for more information.
